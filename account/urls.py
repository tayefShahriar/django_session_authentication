...
from account.views import RegistrationView, ActivateView, ActivationConfirm, GetCSRFToken, CheckAuthenticatedView, LoginView, UserDetailView, LogoutView, ChangePasswordView, DeleteAccountView, ResetPasswordEmailView, ResetPasswordView, ResetPasswordConfirmView
